...
export class Default1742766100890 implements MigrationInterface {
  name = 'Default1742766100890';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "order_products" ("product_id" uuid NOT NULL, "order_id" uuid NOT NULL, CONSTRAINT "PK_df651f408724961907ab06672fa" PRIMARY KEY ("product_id", "order_id"))`,
    );
    await queryRunner.query(
